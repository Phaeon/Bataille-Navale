...
/**
 * Classe qui gère l'animation finale lors d'une victoire.
 * 
 * @author jackhogg
 * @version 1.0
 */
public class AnimationFinJoueur extends Thread {

	private BatailleNavale B;
	private JButton[][] boutons;
	private GameAPI game;

	public AnimationFinJoueur(BatailleNavale B, GameAPI game, JButton[][] boutons) {
		this.B = B;
	...
	public void run() {
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 5; j++) {
				if ((i == 2 && j == 3) || (i == 3 && j == 3) || (i == 6 && j == 2) || (i == 7 && j == 2)
						|| (i == 7 && j == 3) || (i == 7 && j == 4) || (i == 8 && j == 3) || (i == 8 && j == 4)) {
